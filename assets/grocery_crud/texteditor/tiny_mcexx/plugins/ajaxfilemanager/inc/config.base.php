...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PASSWORD', 'md1234');
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../files/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../files/');	//accept relative path only
