			    ...
			    <table class="adminLoginTable" cellpadding="0" cellspacing="0">
			        ...
			        <tbody>
			            <tr>
			                ...
			                <td class="padTop"><input type="text" value="<?php //echo CONFIG_LOGIN_USERNAME; ?>" class="input" name="username" id="username" /></td>
			            </tr>
			            <tr>
			                <th><label><?php echo LOGIN_PASSWORD; ?> </label></th>
			                <td><input type="password" value="<?php //echo CONFIG_LOGIN_PASSWORD; ?>" class="input" name="password" id="password" /></td>
			            </tr>
			        </tbody>
			        <tfoot>
			            <tr>
