...
<div class="twitter-bootstrap crud-form">
	<div class="portlet box blue">
		<div class="portlet-title">
            <h4><i class="icon-reorder"></i><?php echo $this->l('form_edit'); ?> <?php echo $subject?></h4>
        </div>
        <div class="portlet-body form">
			...
			{
				?>
				<div class="control-group" id="<?php echo $field->field_name; ?>_field_box">
					<label class="control-label" id="<?php echo $field->field_name; ?>_display_as_box">
