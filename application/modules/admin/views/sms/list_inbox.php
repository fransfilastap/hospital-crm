         ...
         <script type="text/javascript" src="<?php echo site_url("assets/back/js/CRMPublisher.js") ?>"></script>
          <div class="row-fluid">
					<div class="span12">
                        ...
                        <h4><i class="icon-reorder"></i>Kotak Masuk</h4>
                        <div class="tools">
                     ...
                     <div class="portlet-body form">
                        ...
                        <table class="table table-striped table-bordered" id="inbox">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-phone">Nomor Telepon</th>
                        ...
                        <div  id="removalModal"class="modal hide fade">
                           <div class="modal-header"><h5><b>Hapus Pesan Masuk</b></h5></div>
        ...
        <script type="text/javascript">
          ...
          $(document).ready(function(){
              CRM_APP.smsGateaway( "<?php echo site_url('admin/smsgateaway/inbox_list') ?>", "#inbox" );
              CRM_APP.replySMS("<?php echo site_url('admin/smsgateaway/get') ?>","<?php echo site_url('admin/smsgateaway/proses_kirim') ?>","<?php echo site_url('admin/smsgateaway/set_read') ?>");
              ...
              $(".delete").live("click",function(){
                ...
                link  = "<?php echo site_url('admin/smsgateaway/inbox_delete'); ?>"+"/"+id;
