          ...
          <div class="row-fluid">
            <div class="portlet box blue">
              <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>Laporan Kunjungan Poli</h4>
                        <div class="tools">
            ...
            <a id="cetak" target="_blank" href="<?php echo site_url("admin/report/report_poli") ?>" class="btn green"><i class="icon-print icon-white"></i> Cetak</a>
          </div>
          ...
          <script type="text/javascript">
            $(document).ready(function(){
                ...
                var generate = function(start,end){
                    ...
                    $.post("<?php echo site_url('admin/report/ambil_rpoli') ?>",{"start":start,"end":end},function(data){
