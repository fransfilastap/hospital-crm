                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>Registrasi Ulang</h4>
                        <div class="tools">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form method="POST" action="<?php echo site_url("admin/kunjungan_poli/proses_registrasi") ?>" class="form-horizontal" id="menu_form" />
                           <div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="nomor_urut" id="nomor_urut" class="span6 m-wrap" type="text" placeholder="Nomor urut" value="" readonly="readonly"/>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <select name="pasien" class="span6 chosen" data-placeholder="Pilih Pasien..." tabindex="1">
                                    <option value="" />
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="tanggal_kunjungan" class="m-wrap m-ctrl-medium" size="16" type="text" value="" id="tanggal_kunjungan" />
                              </div>
                           </div>
                           <div class="control-group">
